...
const BASE_URL = 'https://fortnite-api.com/v1/stats/br/v2/9c9aa7c866754a1aa260336697a5438b';
...
const Michal = () => {
    ...
    return (
        <div class="all">
      {
        data ?
      <div class="player"> 
        <div className="player_name item">
          <h1>{data.data.account.name}</h1> 
       <div className="play_time">
          {data.data.stats.all.overall.minutesPlayed}
       </div> 
       <div className="play_time">
